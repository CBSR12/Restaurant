...
export default function CustomerPage({ changeState, customerData }) {
  ...
  const handleSave = async () => {
    try {
      const res = await fetch(`http://localhost:3000/customer/${customer.user.customer_id}`, {
        method: "PUT",
        ...
        <>
          <label>
            ...
            <input
              ...
              onChange={(e) => setCustomer({ ...customer, user: {...customer.user, c_name: e.target.value }})}
            />
          </label>
          <label>
            Phone Number:
            <input
              ...
              onChange={(e) => setCustomer({ ...customer, user: {...customer.user, phonenumber: e.target.value }})}
            />
          </label>
          <label>
            Allergies:
            <input
              ...
              onChange={(e) => setCustomer({ ...customer, user: {...customer.user, allergies: e.target.value }})}
            />
          </label>
